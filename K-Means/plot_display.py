...
# Update the plot
scatter = plt.scatter(pca_df['Component 2'], pca_df['Component 1'], alpha=1, color='red')
plt.title('Two dimensional Iris PCA')
plt.xlabel('Component 1')
plt.ylabel('Component 2')
plt.grid(True, which='both', linestyle='--', linewidth=0.5, alpha=0.5)
...
# Update the plot
scatter = plt.scatter(pca_df['Component 1'], pca_df['Component 2'], alpha=1, color='green')
plt.title('Two dimensional Iris PCA')
plt.xlabel('Component 1')
plt.ylabel('Component 2')
plt.grid(True, which='both', linestyle='--', linewidth=0.5, alpha=0.5)
